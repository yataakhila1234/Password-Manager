...
class App extends Component {
  ...
  addContent = e => {
    ...
    const classValue = colorList[Math.floor() * 5]
    const newValues = {
      id: uuidv4(),
  ...
  deleteItem = id => {
    ...
    const caseDf = newList.length !== 0
    this.setState({latestList: newList, isTrue: caseDf})
  }
